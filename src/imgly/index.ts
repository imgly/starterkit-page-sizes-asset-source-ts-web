 ...
 * Import and call `initPageSizesEditor()` to configure a CE.SDK instance for design editing
 ...
 */
export async function initPageSizesEditor(cesdk: CreativeEditorSDK) {
  // ============================================================================
  ...
  // Add custom dock button to dock order (at the beginning)
  ...
  await cesdk.loadFromURL(
    'https://img.ly/showcases/cesdk/cases/page-sizes/page-sizes.scene'
  );
}
